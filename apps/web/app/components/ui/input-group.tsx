...
function InputGroupAddon({
  ...
  return (
    // eslint-disable-next-line jsx-a11y/click-events-have-key-events, jsx-a11y/no-noninteractive-element-interactions -- 余白クリック時にinputへフォーカスするための補助処理。inputはTab等で直接操作可能
    <div
      role="group"
